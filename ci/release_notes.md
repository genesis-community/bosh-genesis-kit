...
- Updated vault-credhub-proxy from 1.1.7 to 1.1.9

# Bug Fixes

* Removed erroneous reference to a development version of genesis 'gtest'
  accidentally left in to the addons script.

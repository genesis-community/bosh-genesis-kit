module github.com/genesis-project/bosh-genesis-kit/spec
...
require (
	github.com/genesis-community/testkit v0.0.0-20201019192431-73745e0ca145
...
require (
	...
	github.com/itchyny/timefmt-go v0.1.0 // indirect
